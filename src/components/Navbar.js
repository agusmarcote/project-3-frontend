...
{/* 
        <NavLink className={(element) => element.isActive ? 'selected' : 'unSelected'} to="/"><FontAwesomeIcon icon={faHouse} className="footbar-icons" /></NavLink> */}
         ...
         <ul>
            ...
            <NavLink  className={(element) => element.isActive ? 'selected' : ''} linkStyle to="/"><p className='linkStyle'>Home</p></NavLink>
            </section>
            {/* <li>
            <h1>
            ...
            {!isLoggedIn && <NavLink className={(element) => element.isActive ? 'selected' : ''} to="/signup"><p className='linkStyle'>Sign up</p></NavLink>}
            {/* </li> */}
            {/* <li>
            <h1>
               <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-circle" viewBox="0 0 16 16">
            ...
            {!isLoggedIn && <NavLink className={(element) => element.isActive ? 'selected' : ''} to="/login"><p className='linkStyle'>Login</p></NavLink>}
            {/* </li> */}
            ...
            {isLoggedIn && <NavLink className={(element) => element.isActive ? 'selected' : ''} to="/profile"><p className='linkStyle'>Profile</p></NavLink>}
            </li>
            <li className='navLinksFlex'>
            <h1>
            ...
            {isLoggedIn && <NavLink className={(element) => element.isActive ? 'selected' : ''} to="/sales"><p className='linkStyle'>Instruments for sale</p></NavLink>}
            </li>
            <li className='navLinksFlex'>
            <h1>
            ...
            {isLoggedIn && <NavLink className={(element) => element.isActive ? 'selected' : ''} to="/create-sale"><p className='linkStyle'>Sell My Instrument</p></NavLink>}
            </li>
            <li className='navLinksFlex'>
            <h1>
            ...
            {isLoggedIn && <NavLink className={(element) => element.isActive ? 'selected' : ''} to="/events"><p className='linkStyle'>See Events</p></NavLink>}
            </li>
            <li className='navLinksFlex'>
            <h1>
            ...
            {isLoggedIn && <NavLink className={(element) => element.isActive ? 'selected' : ''} to="/create-event"><p className='linkStyle'>Create Event</p></NavLink>}
            </li>
            <li className='navLinksFlex'>
            <h1>
            ...
            {isLoggedIn && <NavLink className={(element) => element.isActive ? 'selected' : ''} to="/classes"><p className='linkStyle'>See Classes</p></NavLink>}
            </li>
            <li className='navLinksFlex'>
            <h1>
            ...
            {isLoggedIn && <NavLink className={(element) => element.isActive ? 'selected' : ''} to="/create-class"><p className='linkStyle'>Create Class</p></NavLink>}
            </li>
            <li className='navLinksFlex'>
            <h1>
