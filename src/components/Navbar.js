   ...
   return (
      <div>
         ...
         <ul>
            ...
            {isLoggedIn &&<NavLink style={{ textDecoration: 'none' }}  className={(element) => element.isActive ? 'selected' : ''} linkStyle to="/home"><p className='linkStyle'>Home</p></NavLink>}
            </section>
            ...
            <li className='navLinksFlex'>
               <h1>
                  {isLoggedIn && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-star" viewBox="0 0 16 16">
