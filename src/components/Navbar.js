   ...
   return (
      <div>
         ...
         <ul>
            ...
            <h1>
            {isLoggedIn &&<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-house-door-fill" viewBox="0 0 16 16">
                  <path d="M6.5 14.5v-3.505c0-.245.25-.495.5-.495h2c.25 0 .5.25.5.5v3.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5Z"/>
               </svg>}
            </h1>
            {isLoggedIn &&<NavLink style={{ textDecoration: 'none' }}  className={(element) => element.isActive ? 'selected' : ''} to="/home"><p className='linkstyle'>Home</p></NavLink>}
            </section>
            ...
            <li className='navLinksFlex'>
               <h1>
                  {isLoggedIn && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-person-circle" viewBox="0 0 16 16">
            ...
            <li className='navLinksFlex'>
               <h1>
                  {isLoggedIn && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-currency-bitcoin" viewBox="0 0 16 16">
            ...
            <li className='navLinksFlex'>
               <h1>
                  {isLoggedIn && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-boombox-fill" viewBox="0 0 16 16">
            ...
            <li className='navLinksFlex'>
               <h1>
                  {isLoggedIn && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-calendar4-event" viewBox="0 0 16 16">
            ...
            <li className='navLinksFlex'>
               <h1>
                  {isLoggedIn && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-calendar2-event" viewBox="0 0 16 16">
                     <path d="M11 7.5a.5.5 0 0 1 .5-.5h1a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5h-1a.5.5 0 0 1-.5-.5v-1z" />
            ...
            <li className='navLinksFlex'>
               <h1>
                  {isLoggedIn && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-clipboard-check" viewBox="0 0 16 16">
            ...
            <li className='navLinksFlex'>
               <h1>
                  {isLoggedIn && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-pen" viewBox="0 0 16 16">
            ...
            <li className='navLinksFlex'>
               <h1>
                  {isLoggedIn && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-star" viewBox="0 0 16 16">
                     <path d="M2.866 14.85c-.078.444.36.791.746.593l4.39-2.256 4.389 2.256c.386.198.824-.149.746-.592l-.83-4.73 3.522-3.356c.33-.314.16-.888-.282-.95l-4.898-.696L8.465.792a.513.513 0 0 0-.927 0L5.354 5.12l-4.898.696c-.441.062-.612.636-.283.95l3.523 3.356-.83 4.73zm4.905-2.767-3.686 1.894.694-3.957a.565.565 0 0 0-.163-.505L1.71 6.745l4.052-.576a.525.525 0 0 0 .393-.288L8 2.223l1.847 3.658a.525.525 0 0 0 .393.288l4.052.575-2.906 2.77a.565.565 0 0 0-.163.506l.694 3.957-3.686-1.894a.503.503 0 0 0-.461 0z" />
                  </svg>}
               </h1>
               {isLoggedIn && <NavLink style={{ textDecoration: 'none' }} className={(element) => element.isActive ? 'selected' : ''} to="/favorites"><p className='linkstyle'>Favorites</p></NavLink>}
            </li>
            <li className='navLinksFlex'>
               <h1>
                  {isLoggedIn && <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-file-earmark-lock2" viewBox="0 0 16 16">
