                ...
                <div className="profileButtons">
                    <div className="buttonPresentationCard">
                        <button className="profileButtonsSvg" onClick={statusProfileHandle}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-person-vcard" viewBox="0 0 24 24">
                    ...
                    <div className="buttonViewSales">
                        <button className="profileButtonsSvg" onClick={statusSaleseHandle}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-currency-exchange" viewBox="0 0 24 24">
                    ...
                    <div className="buttonViewEvent">
                        <button className="profileButtonsSvg" onClick={statusEventsHandle}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-calendar-date" viewBox="0 0 24 24">
                    ...
                    <div className="buttonViewClasses">
                        <button onClick={statusClassesHandle}>
                            <svg className="profileButtonsSvg" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-pen" viewBox="0 0 24 24">
