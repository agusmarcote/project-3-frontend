                ...
                <div className="profileButtons">
                    <div className="buttonPresentationCard">
                        <button className="profileButtonsSvg" onClick={statusProfileHandle}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-person-vcard" viewBox="0 0 35 35">
                    ...
                    <div className="buttonViewSales">
                        <button className="profileButtonsSvg" onClick={statusSaleseHandle}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-currency-exchange" viewBox="0 0 35 35">
                    ...
                    <div className="buttonViewEvent">
                        <button className="profileButtonsSvg" onClick={statusEventsHandle}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" className="bi bi-calendar-date" viewBox="0 0 35 35">
                    ...
                    <div className="buttonViewClasses">
                        <button onClick={statusClassesHandle}>
                            <svg className="profileButtonsSvg bi bi-pen" xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="currentColor" viewBox="0 0 35 35">
