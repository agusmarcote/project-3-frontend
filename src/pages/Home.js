...
export default function Home() {
   return (
      <div>
         <h4 className="missionStatement"><span>For Muscicians </span>By Muscician</h4>
         ...
         <Link className="cardLink flex" to={`/sales`}>
          ...
          <Link className="cardLink flex" to={`/events`}>
               <div className = "CardStyle">
                  ...
                  <p className='textStyleHome'>Fin muscicians to play live at your event!.</p>
          ...
          <Link className="cardLink flex" to={`/classes`}>
               <div className = "CardStyle">
                  ...
                  <h3 className="textStyle">Leanr how to play</h3>
                  <p className='textStyleHome'>Find the best music teachers and start learning how to play an instrument or sing!</p>
                  <p className='textStyleHome'>Advertise your lessons to thasands of potential students TODAY!</p>
